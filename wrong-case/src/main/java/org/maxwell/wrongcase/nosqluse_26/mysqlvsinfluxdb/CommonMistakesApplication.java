package org.maxwell.wrongcase.nosqluse_26.mysqlvsinfluxdb;
...
public class CommonMistakesApplication {
    ...
    private void initInfluxDB() {
        ...
        try (InfluxDB influxDB = InfluxDBFactory.connect("http://59.36.170.213:8086", "Maxwell", "maodihuiMaster", okHttpClientBuilder)) {
