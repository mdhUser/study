...
import org.maxwell.wrongcase.actuator_24.pojo.Order;
...
public class OrderController {
    ...
    public void createOrder(@RequestParam("userId") long userId, @RequestParam("merchantId") long merchantId) {
        ...
        try {
            ...
            //查询商户服务
            Boolean merchantStatus = restTemplate.getForObject("http://localhost:8081/order/getMerchantStatus?merchantId=" + merchantId, Boolean.class);
